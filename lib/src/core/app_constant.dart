...
class KeyUtil {
  ...
  static const quickCalculation = "QuickCalculation";
  static const String mentalArithmetic = "MenthalArithmetic";
  ...
  static int getTimeUtil(GameCategoryType gameCategoryType) {
    switch (gameCategoryType) {
      ...
      case GameCategoryType.PICTURE_PUZLLE:
  ...
  static int quickCalculationPlusTimeOut = 1;
